    ...
    <footer className="bg-navy-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg md:text-xl font-semibold mb-4 md:mb-6">{t('footer.quickLinks')}</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg md:text-xl font-semibold mb-4 md:mb-6">{t('footer.contactInfo')}</h4>
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-start">
                ...
                <span className="text-lg">{t('contact.addressText')}</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-lg">{t('contact.phoneNumber')}</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-lg">{t('contact.emailAddress')}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 md:mt-12 lg:mt-16 pt-6 md:pt-8 border-t border-navy-700 text-center text-gray-400">
          <p className="text-sm md:text-base lg:text-lg">&copy; {new Date().getFullYear()} Company. {t('footer.rights')}</p>
        </div>
      </div>
    </footer>
  )
