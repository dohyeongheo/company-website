        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-navy-900">고품질 서비스</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-navy-900">빠른 대응</h3>
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 text-navy-900">전문 팀</h3>
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
